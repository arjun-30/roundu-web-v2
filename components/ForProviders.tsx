...
export default function ForProviders() {
  ...
  return (
    <section id="providers" ref={ref} className="relative py-32 overflow-hidden">
      ...
      {/* Glow */}
      <div className="orb orb-amber w-[700px] h-[700px] top-0 right-0 animate-pulse-glow" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <motion.p
              ...
              className="font-mono text-xs tracking-[0.3em] text-amber-400 uppercase mb-6"
            >
              [ for providers ]
            </motion.p>
            ...
            <motion.p
              ...
              className="mt-8 text-lg text-bg/65 leading-relaxed max-w-lg"
            >
